...
threads~\cite{aamodt_book}, so a single memory
...
32-entry L1 TLB~\cite{pichai_gpu_translation}, flushed at kernel boundaries; on the
...
GPU workloads~\cite{avoiding_tlb,latpc}.
