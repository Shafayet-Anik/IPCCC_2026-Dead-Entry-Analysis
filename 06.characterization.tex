...
\begin{figure}[ht]
  ...
  measurable dead-entry activity. Hatched bars are from truncated-trace
  baselines.}
  \label{fig:reuse}
\end{figure}
...
Four hatched bars reflect truncated-trace baselines; direction matches
the fully-traced majority.
